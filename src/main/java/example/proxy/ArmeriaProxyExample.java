...
public final class ArmeriaProxyExample {

    private static final Logger logger = LoggerFactory.getLogger(ArmeriaProxyExample.class);
    ...
    static Server newBackendServer(int port, int frameIntervalMillis) throws Exception {
        return Server.builder()
                     ...
                     .service("/", HttpFile.builder(ArmeriaProxyExample.class.getClassLoader(), "index.html")
